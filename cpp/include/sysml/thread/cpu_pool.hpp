...
#include "sysml/thread/barrier.hpp"
#include "sysml/thread/core.hpp"
#include "sysml/thread/cpu_set.hpp"
...
public:
    ...
    void enforce()
    {
        SYSML_STRONG_ASSERT(thread_id_ == std::this_thread::get_id());
    }
};
...
private:
    // dabun::detail::primitive_alignedxf_wrapper<
