...
#    include "sysml/code_generator/detail/apple.hpp"
#endif
...
#    if defined(__APPLE__)
        int const mode =
            ...
            ((::sysml::detail::code_generator::get_macOS_version() >=
                      ::sysml::detail::code_generator::mojave_version
                  ? MAP_JIT
                  : 0));
#    else
...
inline memory_resource* memory_resource::default_resource()
{
    ...
    if (::sysml::detail::code_generator::get_macOS_version() >=
        hask::mojave_version)
    {
